...
import {getPopularMovies, getRunningOperationPromises, useGetPopularMoviesQuery} from "@/services/themoviedb";
import {useRouter} from "next/router";
import {useAppDispatch, useAppSelector} from "@/hooks/redux";
import React, {useEffect, useRef, useState} from "react";
import {useObserver} from "@/hooks/useObserver";
import {reset, setPage, setPopularMovies, setTotalPages} from "@/features/movie/popularSlice";
...
const Movies: NextPage = () => {
    ...
    const {data: movies, isLoading, isError, isFetching} = useGetPopularMoviesQuery(page);
    ...
    return (
        <div>
            <h1 className="dark:text-white text-6xl text-center m-0">Movies</h1>
            <MoviesList/>
